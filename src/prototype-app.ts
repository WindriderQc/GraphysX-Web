...
export class PrototypeApp {
  ...
  private installDebugHooks(): void {
    const debugApi = {
      ...
      addAgentWorldJoint: (joint: AgentWorldJointDefinition) => this.raceScene.addAgentWorldJoint(joint),
      updateAgentWorldJoint: (id: string, patch: AgentWorldJointPatch) => this.raceScene.updateAgentWorldJoint(id, patch),
      removeAgentWorldJoint: (id: string) => this.raceScene.removeAgentWorldJoint(id),
      ...
      steerAgentEntity: (id: string, input: AgentWorldSteerInput) => this.raceScene.steerAgentWorld(id, input),
      ...
      agentWorldEvents: (since?: number) => this.raceScene.readAgentWorldEvents(since),
      agentWorldRules: () => this.raceScene.getAgentWorldRules(),
      setAgentWorldRules: (rules: Parameters<RaceScene["setAgentWorldRules"]>[0]) => this.raceScene.setAgentWorldRules(rules),
      agentWorldRunStatus: () => this.raceScene.agentWorldRunStatus(),
    ...
    const agentApi = {
      ...
      addJoint: debugApi.addAgentWorldJoint,
      updateJoint: debugApi.updateAgentWorldJoint,
      removeJoint: debugApi.removeAgentWorldJoint,
      ...
      steer: debugApi.steerAgentEntity,
      ...
      events: debugApi.agentWorldEvents,
      rules: {
        get: debugApi.agentWorldRules,
        set: debugApi.setAgentWorldRules,
        status: debugApi.agentWorldRunStatus,
        standings: debugApi.agentWorldRaceStandings,
