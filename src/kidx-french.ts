const COPY: Record<string, string> = {
  ...
  "Forward": "Avancer", "Fwd": "Avancer", "Left": "Gauche", "Right": "Droite", "Stop": "Arrêt",
  "Go": "Avancer", "Run": "Démarrer", "Undo": "Enlever", "Drive": "Piloter", "Build": "Programmer",
  "Try again": "Réessayer", "Drive mode": "Piloter le robot", "Build mode": "Programmer", "Build program": "Préparer le programme", "Run program": "Démarrer le programme",
  "Undo block": "Enlever le dernier bloc", "Your program": "Ton programme", "Tap blocks below to build": "Choisis tes blocs ci-dessous",
  "✕ Leave the lab": "← Atelier", "Your programs": "Tes programmes", "Programs": "Programmes", "Close": "Fermer",
  "Saved only in this browser. Open a program to build or run it again.": "Tes programmes sont gardés dans ce navigateur. Ouvre un programme pour le modifier ou l’essayer à nouveau.",
  "Program name": "Nom du programme", "Save program": "Enregistrer", "Save a copy": "Enregistrer une copie",
  "Update saved program": "Enregistrer les changements", "Unsaved edits": "À enregistrer", "Saved": "Enregistré", "Not saved": "Non enregistré",
  ...
  "That program was removed. Reopen the library to refresh the list.": "Ce programme a été supprimé. Rouvre Programmes pour voir la liste actuelle.",
  "Your program is ready. Tap Run to test it.": "Ton programme est prêt. Appuie sur Démarrer pour l’essayer.",
  "Three Forward blocks ready. Tap Run to test them.": "Trois blocs Avancer sont prêts. Appuie sur Démarrer.",
  "Program cleared. Start with Forward.": "Tu as enlevé tous les blocs. Commence par Avancer.",
  "Program ready. Tap Run to try it again.": "Programme prêt. Appuie sur Démarrer pour réessayer.",
  "Program opened. Add blocks or tap Run to try it.": "Programme ouvert. Ajoute des blocs ou appuie sur Démarrer.",
  "Build a program: tap Forward three times, then Run.": "Ajoute trois blocs Avancer, puis appuie sur Démarrer.",
  ...
  "That saved program changed. Reopen the library before deleting it.": "Ce programme a changé. Rouvre Programmes avant de le supprimer.",
};
...
export function kidxFrench(text: string): string {
  ...
  const patterns: [RegExp, (...matches: string[]) => string][] = [
    ...
    [/^(.+) added\. Add more blocks, then tap Run\.$/, (_, name) => `Bloc ${COPY[name] ?? name} ajouté. Ajoute des blocs, puis appuie sur Démarrer.`],
