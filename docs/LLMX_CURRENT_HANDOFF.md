...
**Household 1.58.10 is deployed:** [PR626](https://github.com/WindriderQc/aiOPs/pull/626), merge `c62c5f779daedb5090545f828046021dba694bbe`, [deployment34883543953](https://github.com/WindriderQc/aiOPs/actions/runs/34883543953). Live status confirms it; all290 Household tests and PR CI pass. Automatic client tool choice lets ordinary dialogue use the existing verified native final answer. Scene edits still require a completed `graphysx_reply` call; text cannot apply a scene. The earlier greeting, cross-origin worklet and shared voice fixes remain integrated.
