...
try {
  ...
  for (const [id, blocks] of Object.entries(solutions)) {
  ...
  console.log("  ok  five French missions finish through real block controls and physics, including mandatory checkpoints");
