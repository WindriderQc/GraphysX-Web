...
const builds = ["track3r", "spike3r"].map((id) => JSON.parse(readFileSync(`src/kidx-${id}-build.json`, "utf8")));
...
try {
  ...
  console.log("  ok  both native CAD guides: loading, source normals, steps, highlight, explode/reassemble, rotate/zoom, resume and responsive controls");
