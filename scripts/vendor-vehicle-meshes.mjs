...
// import as vocabulary. The vehicles were already *decoded* — `src/content/cars-catalog.json`
...
// ---------------------------------------------------------------- Impreza
{
  ...
  write("archive-impreza", { meshes }, {
    ...
    provenance: {
      ...
      decodedCatalog: "src/content/cars-catalog.json",
...
//
// The recovered vehicles, converted from the decoded \`src/content/cars-catalog.json\` into the
