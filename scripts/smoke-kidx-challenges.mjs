...
export async function runKidxChallenges({ missionIds = ["reverse-parking", "cargo-push", "sensor-retreat", "ramp-crossing", "color-detect", "touch-and-back"] } = {}) {
