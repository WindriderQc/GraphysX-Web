...
export const VERIFY_SMOKES = [
  ...
  { name: "llmx-creation-actions", tier: "apps", script: "scripts/smoke-llmx-creation-actions.mjs", covers: "Native scene proposals and exact receipts, stale undo rejection, corrected French math history and workshop separation" },
  { name: "llmx-creation-math", tier: "apps", script: "scripts/smoke-llmx-creation-math.mjs", covers: "Deterministic quantities, discrete steps, undo/redo, portrait camera and workshop visibility during ordinary creation" },
  { name: "llmx-creation-library", tier: "apps", script: "scripts/smoke-llmx-creation-library.mjs", covers: "UI-authored math, named copy/rename/open/reload and stale world rejection" },
  { name: "llmx-creation-family", tier: "apps", script: "scripts/smoke-llmx-creation-family.mjs", covers: "Isolated Family worlds and traffic, mobile counting controls, personal restoration and saved math resumption" },
  ...
  { name: "llmx-face-embed", tier: "apps", script: "scripts/smoke-llmx-face-embed.mjs", covers: "Built <llmx-face> module alone: one file, drawn mask, presence contract, speaking/sleeping, math scene receipts and release on removal" },
